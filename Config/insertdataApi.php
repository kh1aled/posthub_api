...
//===============Check on Data=============
//=======================================
if (isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password2']) && isset($_FILES['avatar'])) {
    ...
    $stmt->bind_param("ssssss", $fname, $lname, $username, $email, $hashedPassword, $file_url);
